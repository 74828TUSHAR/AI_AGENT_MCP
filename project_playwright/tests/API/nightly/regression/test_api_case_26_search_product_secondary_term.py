...
@allure.title("API Case 26 - Search product with secondary term")
async def test_api_case_26_search_product_secondary_term(api_client, test_record):
    scenarios = {
        "scenario_1": "Send POST request to search product API using secondary search term and verify successful response"
    }
    log_api_header(logger, "test_api_case_26_search_product_secondary_term", scenarios)

    test_name = "test_api_case_26_search_product_secondary_term"

    # ============================================================
    # SCENARIO 1: Send POST request to search product API using secondary search term and verify successful response
    # ============================================================
    with allure.step("Scenario 1: Search product with secondary term"):
        async def scenario():
