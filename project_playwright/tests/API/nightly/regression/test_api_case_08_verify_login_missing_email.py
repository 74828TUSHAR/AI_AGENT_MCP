...
@allure.title("API Case 08 - Verify login without email")
async def test_api_case_08_verify_login_missing_email(api_client, test_record):
    scenarios = {
        "scenario_1": "Send POST request to verify login API without email and verify bad request response"
    }
    log_api_header(logger, "test_api_case_08_verify_login_missing_email", scenarios)

    test_name = "test_api_case_08_verify_login_missing_email"

    # ============================================================
    # SCENARIO 1: Send POST request to verify login API without email and verify bad request response
    # ============================================================
    with allure.step("Scenario 1: Verify login without email"):
        async def scenario():
