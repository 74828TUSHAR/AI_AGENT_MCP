...
@allure.title("API Case 07 - Verify login with valid details")
async def test_api_case_07_verify_login_valid(api_client, test_record):
    scenarios = {
        "scenario_1": "Send POST request to verify login API with valid email and password"
    }
    log_api_header(logger, "test_api_case_07_verify_login_valid", scenarios)

    test_name = "test_api_case_07_verify_login_valid"

    # ============================================================
    # SCENARIO 1: Send POST request to verify login API with valid email and password
    # ============================================================
    with allure.step("Scenario 1: Verify valid login"):
        async def scenario():
