...
@allure.title("API Case 01 - Get all products list")
async def test_api_case_01_get_all_products_list(api_client, test_record):
    scenarios = {
        "scenario_1": "Send GET request to products list API and verify successful response"
    }
    log_api_header(logger, "test_api_case_01_get_all_products_list", scenarios)

    test_name = "test_api_case_01_get_all_products_list"

    # ============================================================
    # SCENARIO 1: Send GET request to products list API and verify successful response
    # ============================================================
    with allure.step("Scenario 1: GET products list"):
        async def scenario():
